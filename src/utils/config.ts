export const SITE = {
  ...
  description: 'Kompletny przewodnik po copywritingu. Definicje, zasady, formuły, techniki pisania i praktyczne poradniki. Wszystko o copywritingu w jednym miejscu.',
  url: 'https://1copywriting.pl',
...
export const SILOS = [
  {
    ...
    description: 'Definicje, wyjaśnienia i wprowadzenie do świata copywritingu.',
    icon: '📖',
    color: '#E8453C',
  },
  {
  ...
  },
  {
    slug: 'jak-pisac',
    title: 'Jak pisać',
    description: 'Praktyczne poradniki: nagłówki, CTA, posty, e-maile, reklamy.',
    icon: '🚀',
    color: '#E8453C',
  },
];
